...
describe('es6', () => {
    ...
    describe('#Dictionary', () => {
        ...
        it('Добавление', () => {
            const dic = new core.Dictionary();
            assert.strictEqual(dic.set(4,4), false);
            assert.strictEqual(dic.set('И','B'), true);
        });

        it('Извлечения элемента', () => {
            const dic = new core.Dictionary();
            assert.strictEqual(dic.get('Ag'), false);
            dic.set('BB','Bg');
            assert.strictEqual(dic.get(2), false);
            assert.strictEqual(dic.get('BB'), 'Bg');
